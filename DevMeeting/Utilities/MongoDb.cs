...
namespace DevMeeting.Utilities
{
    ...
    public class MongoDb : IMongoDb
    {
        ...
        public async Task<List<TDocument>> InsertDocumentsAsync<TDocument>(List<TDocument> documents, string collectionName)
        {
        ...
        public async Task<bool> CreateCollectionAsync<TDocument>(string collectionName, CreateCollectionOptions<TDocument> options)
        {
        ...
        /// <param name="keysDefinition"></param>
        /// <returns></returns>
        public async Task<bool> CreateIndexAsync<TDocument>(string collectionName, CreateIndexModel<TDocument> keysDefinition)
        {
